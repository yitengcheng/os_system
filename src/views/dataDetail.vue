<template>
  <div class="contain">
    <PageTitle label="资料详情" />
    <h1 class="title">公司发文{{data}}号</h1>
    <p class="desc">
      <span style="marginLeft:40px"></span>感盘古开辟，三皇治世，五帝定伦，世界之间，遂分为四大部洲：曰东胜神洲，曰西牛贺洲，曰南赡部洲，曰北俱芦洲。这部书单表东胜神洲。海外有一国土，名曰傲来国。国近大海，海中有一座名山，唤为花果山。此山乃十洲之祖脉，三岛之来龙，自开清浊而立，鸿蒙判后而成。真个好山！有词赋为证，赋曰：
    ...
    <el-button type="danger" class="downloadBtn">点击下载附件</el-button>
  </div>
</template>
